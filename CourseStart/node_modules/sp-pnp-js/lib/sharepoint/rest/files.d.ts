...
export declare class TextFileParser implements ODataParser<any, string> {
    parse(r: Response): Promise<string>;
}
export declare class BlobFileParser implements ODataParser<any, Blob> {
    parse(r: Response): Promise<Blob>;
}
export declare class BufferFileParser implements ODataParser<any, ArrayBuffer> {
